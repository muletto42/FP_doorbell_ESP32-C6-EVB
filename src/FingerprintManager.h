...
//#define mySerial Serial1 // das w#re für den anderen Stecker GPIO5/6
#define mySerial Serial0 // GPIO16/17 ist richtig
...
*/
const int touchRingPin = 0;     // touch/wakeup pin connected to fingerprint sensor
...
class FingerprintManager {       
  ...
  public:
    ...
    void deleteIDgarage(int id);
    void addIDgarage(int id, String name);
    void deleteIDdoor(int id);
    void addIDdoor(int id, String name);

    bool matchForDoor(uint16_t matchId);
    bool matchForGarage(uint16_t matchId);
